...
In live mode, I would return actual supplier or website results from EventFlow where available.`,quickReplies:["Budget breakdown","Venue checklist","Planning timeline","Supplier questions"]}:e.includes("budget")||e.includes("cost")||e.includes("price")?{content:`For a ${i} in ${o}, start with this practical budget split:
...
If you give me your guest count and rough budget, I can make the numbers more specific.`,quickReplies:["Venue checklist","Planning timeline","Supplier questions"]}:e.includes("timeline")||e.includes("schedule")||e.includes("when")||e.includes("plan")?{content:`A sensible ${i} planning order is:
...
- In the final month, lock final numbers, balances and the day schedule.`,quickReplies:["Find suppliers","Budget breakdown","Venue checklist"]}:{content:"I can help with that. To give you useful advice, what type of event are you planning?",quickReplies:["Wedding","Birthday Party","Corporate Event","Anniversary","Other"]}}}function x(r,e,a,i,o,t,s,n,u,c){return`
    * {
  ...
  `}const v='<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><line x1="1" y1="1" x2="9" y2="9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><line x1="9" y1="1" x2="1" y2="9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>';class w{constructor(e={}){this.isMenuOpen=!1,this.showClearConfirm=!1,this.showExportToast=!1,this.config={...g,...e},this.apiClient=new b(this.config.apiBaseUrl,this.config.authToken),this.config.debug&&(console.log("[JadeWidget] Initializing with config:",this.config),console.log("[JadeWidget] Avatar URL:",this.config.avatarUrl));try{localStorage.setItem("__jade_test__","1"),localStorage.removeItem("__jade_test__")}catch{console.warn("[JadeWidget] localStorage is unavailable – chat history, sound settings and session state will not be persisted across page loads.")}this.escapeKeyHandler=t=>{t.key==="Escape"&&(this.showClearConfirm?(this.showClearConfirm=!1,this.render()):this.isMenuOpen?(this.isMenuOpen=!1,this.render()):this.state.isOpen&&this.closeChat())},this.soundEnabled=d.loadSoundEnabled(),this.soundVolume=d.loadSoundVolume();const a=d.loadState(),i=d.loadMessages(),o=d.loadConversationId();this.state={isOpen:a.isOpen||!1,isMinimized:a.isMinimized||!1,showGreeting:!1,conversationId:o||void 0,messages:i.length>0?i:this.getInitialMessages()},this.container=document.createElement("div"),this.container.className="jade-widget-root",this.shadowRoot=this.container.attachShadow({mode:"open"}),this.render(),this.attachEventListeners()}getInitialMessages(){return[{id:"initial",role:"assistant",content:this.config.greetingText,timestamp:Date.now(),quickReplies:["Yes, please","No, thanks"]}]}render(){const e=x(this.config.primaryColor,this.config.accentColor,this.config.fontFamily,this.config.offsetBottom,this.config.offsetRight,this.config.offsetLeft,this.config.offsetBottomMobile,this.config.offsetRightMobile,this.config.offsetLeftMobile,this.config.scale);this.shadowRoot.innerHTML=`
    ...
    `}renderGreeting(){return this.config.greetingTooltipText?`
      <div class="jade-greeting-tooltip" data-action="open-chat" role="tooltip" aria-live="polite">
        <button class="jade-greeting-close" aria-label="Dismiss greeting" data-action="close-greeting">${v}</button>
