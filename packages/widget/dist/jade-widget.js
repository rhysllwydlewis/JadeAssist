...
In live mode, I would return actual supplier or website results from EventFlow where available.`,quickReplies:["Budget breakdown","Venue checklist","Planning timeline","Supplier questions"]}:e.includes("budget")||e.includes("cost")||e.includes("price")?{content:`For a ${s} in ${o}, start with this practical budget split:
...
If you give me your guest count and rough budget, I can make the numbers more specific.`,quickReplies:["Venue checklist","Planning timeline","Supplier questions"]}:e.includes("timeline")||e.includes("schedule")||e.includes("when")||e.includes("plan")?{content:`A sensible ${s} planning order is:
...
`),t=[];let i=!1,n=null;for(let c=0;c<o.length;c++){const u=o[c],h=/^[-*•]\s+(.*)/.exec(u),f=/^\d+\.\s+(.*)/.exec(u);h?((!i||n!=="ul")&&(i&&t.push(n==="ol"?"</ol>":"</ul>"),t.push('<ul class="jade-md-list">'),i=!0,n="ul"),t.push(`<li>${h[1]}</li>`)):f?((!i||n!=="ol")&&(i&&t.push(n==="ul"?"</ul>":"</ol>"),t.push('<ol class="jade-md-list">'),i=!0,n="ol"),t.push(`<li>${f[1]}</li>`)):(i&&(t.push(n==="ol"?"</ol>":"</ul>"),i=!1,n=null),u.trim()===""?t.push("<br>"):t.push(u))}return i&&t.push(n==="ol"?"</ol>":"</ul>"),t.join(`
